...
"""Processor pipeline for Diffusion DiT policy."""
...
def make_diffusion_dit_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for Diffusion DiT policy.
    ...
    Args:
        config: The configuration object for the Diffusion DiT policy,
