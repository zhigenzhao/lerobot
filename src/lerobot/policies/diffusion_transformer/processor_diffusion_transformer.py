...
"""Processor pipeline for Diffusion Transformer policy."""
...
def make_diffusion_transformer_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for Diffusion Transformer policy.
    ...
    Args:
        config: The configuration object for the Diffusion Transformer policy,
