...
class DiffusionTransformerConfig(PreTrainedConfig):
    """Configuration class for DiffusionTransformerPolicy.
    ...
    Args:
        ...
        horizon: Diffusion model action prediction size as detailed in `DiffusionTransformerPolicy.select_action`.
        n_action_steps: The number of action steps to run in the environment for one invocation of the policy.
            See `DiffusionTransformerPolicy.select_action` for more details.
