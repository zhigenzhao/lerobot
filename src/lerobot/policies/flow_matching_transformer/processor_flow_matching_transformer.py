...
"""Processor pipeline for Flow Matching Transformer policy."""
...
def make_flow_matching_transformer_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for Flow Matching Transformer policy.
    ...
    Args:
        config: The configuration object for the Flow Matching Transformer policy,
