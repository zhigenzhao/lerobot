...
"""Processor pipeline for Hybrid Diffusion policy."""
...
def make_hybrid_diffusion_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for Hybrid Diffusion policy.
    ...
    Args:
        config: The configuration object for the Hybrid Diffusion policy,
