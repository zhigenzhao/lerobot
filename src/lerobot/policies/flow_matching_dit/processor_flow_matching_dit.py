...
"""Processor pipeline for Flow Matching DiT policy."""
...
def make_flow_matching_dit_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for Flow Matching DiT policy.
    ...
    Args:
        config: The configuration object for the Flow Matching DiT policy,
