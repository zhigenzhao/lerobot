...
"""Processor pipeline for VQFlow policy."""
...
def make_vqflow_pre_post_processors(
    config: VQFlowConfig,
    ...
    """
    Constructs pre-processor and post-processor pipelines for VQFlow policy.
    ...
    Args:
        config: The configuration object for the VQFlow policy,
